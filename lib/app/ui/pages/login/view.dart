                ...
                children: <Widget>[
                  ...
                  Container(
                    child: CommonButton(
                      ...
                      onPressed: () {
                        _onLoginButtonPressed(controller);
                      },
                    ),
...
void _onLoginButtonPressed(LoginController controller) {
  print(
      "data kirim nama ${controller.employeeNumberInput.text}, Password ${controller.passwordInput.text}");
  controller.login();
}
